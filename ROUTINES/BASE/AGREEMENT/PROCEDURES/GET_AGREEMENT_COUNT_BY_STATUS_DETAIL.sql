...
DECLARE LS_IS_HOLD_CONDITION VARCHAR(250);
...
SET LS_OFFSET = (AV_LIMIT * AV_PAGED);
    ...
    ELSE
        ...
        END IF;
    END IF;
	IF AV_IS_HOLD = 'N' THEN
		SET LS_IS_HOLD_CONDITION = ' T1.IS_HOLD = ''N'' OR T1.IS_HOLD IS NULL ';
	ELSE
		SET LS_IS_HOLD_CONDITION = ' T1.IS_HOLD = ''Y'' ';
	END IF;
...
SET LS_DYN_SQL = CONCAT(LS_DYN_SQL,'
            ...
            WHERE T1.AGREEMENT_SEQUENCE_STATUS <> ''TEMPLATE'' AND (',LS_IS_HOLD_CONDITION,')
