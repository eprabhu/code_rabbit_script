    ...
    WITH ACCESS_TMP_ADMIN 
        ...
        AGGREGATED AS (
            SELECT
                ...
                COUNT(CASE WHEN IS_HOLD = ''N'' OR IS_HOLD IS NULL THEN 1 END) AS RECORD_COUNT,
                COUNT(CASE WHEN IS_HOLD = ''Y'' THEN 1 END) AS HOLD_COUNT
            FROM (
                SELECT DISTINCT
                ...
                WHERE T1.AGREEMENT_SEQUENCE_STATUS <> ''TEMPLATE'' 
