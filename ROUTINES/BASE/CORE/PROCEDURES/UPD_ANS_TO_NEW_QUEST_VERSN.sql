...
DECLARE LV_FILE_PATH varchar(300);
DECLARE LV_FILE_DATA_ID varchar(300);
DECLARE LV_IS_ARCHIVED varchar(300);
     ...
     IF DONE1 THEN
      ...
      AND T4.ANSWER_TYPE = LS_ANSWER_TYPE
		...
		FETCH SEL_QUEST_ANSWER INTO LI_OPTION_NUMBER,LI_QUESTIONNAIRE_ANSWER_ID,LS_QUESTION_NUMBER,LS_ANSWER_TYPE,LI_QUESTION_ID,LI_ANSWER_NUMBER,LI_ANSWER,LI_ANSWER_LOOKUP_CODE,LI_EXPLANATION,LV_ATTACHMENT_ID,LI_QUESTIONNAIRE_ANS_HEADER_ID ;
            ...
            FETCH QUEST_ATT INTO LV_ATTACHMENT_ID,LV_QUESTIONNAIRE_ANSWER_ID,LV_ATTACHMENT,LV_FILE_NAME,LV_CONTENT_TYPE,LV_UPDATE_TIMESTAMP,LV_UPDATE_USER,LV_FILE_PATH,LV_IS_ARCHIVED,LV_FILE_DATA_ID;
			...
			END IF;
              ...
              (QUESTIONNAIRE_ANSWER_ATT_ID, QUESTIONNAIRE_ANSWER_ID, ATTACHMENT, FILE_NAME, CONTENT_TYPE, UPDATE_TIMESTAMP, UPDATE_USER,FILE_PATH,IS_ARCHIVED,FILE_DATA_ID)
              VALUES(LI_QUEST_ATT_ID, LI_QUEST_ANSWER_ID, LV_ATTACHMENT, LV_FILE_NAME, LV_CONTENT_TYPE, LV_UPDATE_TIMESTAMP ,LV_UPDATE_USER,LV_FILE_PATH,LV_IS_ARCHIVED,LV_FILE_DATA_ID);
			SET SQL_SAFE_UPDATES=0;
