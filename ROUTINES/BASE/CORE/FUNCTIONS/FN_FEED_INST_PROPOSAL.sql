...
CLUSTER_CODE,
DURATION)			
SELECT 	AV_UPDATE_USER,utc_timestamp(),T1.HOME_UNIT_NUMBER,T1.HOME_UNIT_NAME,AV_INST_PROPOSAL_NUMBER,LI_SEQUENCE_NUMBER,T1.TYPE_CODE,T1.TITLE,T1.SPONSOR_CODE,
...
T1.GRANT_HEADER_ID,T1.GRANT_TYPE_CODE,utc_timestamp(),ABSTRACT_DESC,
T1.AWARD_TYPE_CODE,
