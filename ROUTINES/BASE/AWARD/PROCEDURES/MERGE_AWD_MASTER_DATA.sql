-- `MERGE_AWD_MASTER_DATA`; 

CREATE PROCEDURE `MERGE_AWD_MASTER_DATA`(AV_ID INT)
BEGIN
...
DECLARE LS_SPONSOR_AWARD_NUMBER			VARCHAR(255);
...
DECLARE LS_DFAFS_NUMBER					VARCHAR(50);
...
DECLARE LS_CFDA_NUMBER					VARCHAR(255);
...
DECLARE LI_AWARD_ID_NEXT_VAL			BIGINT(20);
		BEGIN
				...
				BEGIN
					...
					VALUES(LI_AWARD_ID,LS_AWARD_NUMBER,LI_SEQUENCE_NUMBER,LS_ERROR_MSG,'MERGE_AWD_MASTER_DATA',NULL,NULL,null,UTC_TIMESTAMP(),'admin');
					COMMIT;
				...
				BEGIN
					...
					CALL MERGE_AWD_MASTER_BUDGET(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_KEY_PERSON(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_PROJECT_TEAM(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_CONTACT(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_ROLES(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_REPORT(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_TERMS(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_COST_SHARE(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_SUB_CONTRACT(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_SPECIAL_REVIEW(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_PROJECT_OUTCOME(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_INST_PROPOSAL(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_SPECIAL_APPROVAL(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_OTHER_INFORMATION(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_AWARD_KPI(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_MILESTONE(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_QNR(LI_AWARD_ID,
											   LS_AWARD_NUMBER,
											   LI_SEQUENCE_NUMBER,
											   LS_AWARD_VARIATION_TYPE_CODE,
											   'admin'
					...
					CALL MERGE_AWD_MASTER_AREA_OF_RSRCH(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_DMP_QNR(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					CALL MERGE_AWD_MASTER_MANPOWER(LI_AWARD_ID,
													LS_AWARD_NUMBER,
													LI_SEQUENCE_NUMBER,
													LS_AWARD_VARIATION_TYPE_CODE,
													'admin'
					...
					UPDATE AWARD 
					SET AWARD_SEQUENCE_STATUS = 'ARCHIVE'
