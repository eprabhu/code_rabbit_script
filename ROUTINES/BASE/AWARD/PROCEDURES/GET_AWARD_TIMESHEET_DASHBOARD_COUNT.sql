-- `GET_AWARD_TIMESHEET_DASHBOARD_COUNT`; 

CREATE PROCEDURE `GET_AWARD_TIMESHEET_DASHBOARD_COUNT`(
        AV_AWARD_NUMBER         VARCHAR(20),
        AV_SPONSOR_AWARD_NUMBER VARCHAR(255),
...
END IF;
SET LS_DYN_SQL = CONCAT('SELECT COUNT(*) FROM ( WITH ACCESS_TMP AS (
  SELECT UNIT_NUMBER
