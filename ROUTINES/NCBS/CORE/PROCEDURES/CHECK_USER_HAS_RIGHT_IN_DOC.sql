...
ELSEIF AV_MODULE_CODE = 3 AND (find_in_set ('VIEW_PRIVATE_COMMENTS',AV_RIGHT_NAME) > 0
	OR find_in_set('MAINTAIN_PRIVATE_COMMENTS', AV_RIGHT_NAME) > 0) THEN

			IF FIND_IN_SET('VIEW_PRIVATE_COMMENTS', AV_RIGHT_NAME) > 0 THEN
				set LS_RIGHT_NAME = 'VIEW_PRIVATE_COMMENTS';
			ELSEIF FIND_IN_SET('MAINTAIN_PRIVATE_COMMENTS', AV_RIGHT_NAME) > 0 THEN
				set LS_RIGHT_NAME = 'MAINTAIN_PRIVATE_COMMENTS';
			END IF;
