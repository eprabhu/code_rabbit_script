...
BEGIN
    ...
    SET TAB_QUERY = CONCAT(
        'WITH MODULE_TITLES AS (
            SELECT AGREEMENT_ID AS MODULE_ITEM_KEY, TITLE AS PREV_TITLE, 13 AS MODULE_CODE FROM SR_INT_STAGE_AGREEMENT
            UNION ALL
            SELECT MODULE_ITEM_ID AS MODULE_ITEM_KEY, TITLE AS PREV_TITLE, MODULE_CODE FROM SR_INT_STAGE_ELASTIC_INDEX
        )
        SELECT 
            ...
            T.PREV_TITLE AS PREV_TITLE,
            R.PREV_TITLE AS TITLE,
            T1.ADDED_PERMISSION, 
            T1.DELETED_PERMISSION, 
            T1.PERMISSION_ASSIGNED_USER,
        ...
        LEFT JOIN SR_CATEGORY T11 ON T1.CATEGORY_CODE = T11.CATEGORY_CODE
        LEFT JOIN SR_CATEGORY T12 ON T1.PREV_CATEGORY_CODE = T12.CATEGORY_CODE
