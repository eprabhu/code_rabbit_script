...
ELSEIF AV_WIDGET = 'SERVICE_REQUEST_RESEARCH_SUMMARY' THEN 
         ...
         IF AV_FILTER_TYPE = 'NOT SUBMITTED' THEN

				SET TAB_QUERY = CONCAT(' AND T1.STATUS_CODE = 1 ',LS_FILTER_CONDITIONS);

ELSEIF AV_FILTER_TYPE = 'TOTAL' THEN

				SET TAB_QUERY = CONCAT(LS_FILTER_CONDITIONS);
                
ELSEIF AV_FILTER_TYPE = 'IN PROGRESS' THEN

				SET TAB_QUERY = CONCAT(' AND T1.STATUS_CODE = 15',LS_FILTER_CONDITIONS);

ELSEIF AV_FILTER_TYPE = 'REVISION REQUESTED' THEN

				SET TAB_QUERY = CONCAT(' AND T1.STATUS_CODE = 14',LS_FILTER_CONDITIONS);
