...
OR  (T17.PERSON_ID = ''',AV_PERSON_ID,''' AND T17.ROLE_ID IN (5,7,8))
OR T14.PERSON_ID = ''',AV_PERSON_ID,''' ) ' );
SET JOIN_CONDITION =  CONCAT(JOIN_CONDITION,'   LEFT JOIN EPS_PROPOSAL_PERSONS T14 ON T14.PROPOSAL_ID = T1.PROPOSAL_ID
LEFT JOIN EPS_PROPOSAL_PERSON_ROLES T17 ON T17.PROPOSAL_ID = T1.PROPOSAL_ID ');
