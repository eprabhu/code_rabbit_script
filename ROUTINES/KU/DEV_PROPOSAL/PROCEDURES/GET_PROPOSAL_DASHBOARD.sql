CREATE PROCEDURE `GET_PROPOSAL_DASHBOARD`(
...
IF AV_TAB_TYPE = 'MY_PROPOSAL' THEN
                SET TAB_QUERY = CONCAT(' T8.PERSON_ID = ''',AV_PERSON_ID,''' AND T8.PROP_PERSON_ROLE_ID IN (3,9)');
...
SET LS_DYN_SQL = CONCAT('WITH ACCESS_TMP 
        ...
        SET LS_DYN_SQL =CONCAT(LS_DYN_SQL,'SELECT DISTINCT *  FROM(SELECT DISTINCT  T1.PROPOSAL_ID,
                ...
                T1.START_DATE ',SELECTED_FIELD_LIST,
                   ...
                   LEFT OUTER JOIN PROPOSAL_ADMIN_DETAILS T50 ON T50.DEV_PROPOSAL_ID = T1.PROPOSAL_ID
                        LEFT OUTER JOIN PROPOSAL T51 ON T51.PROPOSAL_ID = T50.INST_PROPOSAL_ID
                        LEFT OUTER JOIN PROPOSAL_STATUS T52 ON T52.STATUS_CODE = T51.STATUS_CODE
                        ...
                        LEFT  JOIN EPS_PROPOSAL_PERSONS T8 ON T8.PROPOSAL_ID = T1.PROPOSAL_ID AND T8.PROP_PERSON_ROLE_ID = 3 AND T8.PI_FLAG = ''Y''
