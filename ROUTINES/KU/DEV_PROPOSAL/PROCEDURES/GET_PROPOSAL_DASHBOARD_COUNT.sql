...
SET LS_DYN_SQL = CONCAT('WITH ACCESS_TMP 
        ...
        SET LS_DYN_SQL =CONCAT(LS_DYN_SQL,'SELECT  count(DISTINCT *)  FROM(SELECT DISTINCT  T1.PROPOSAL_ID,
                ...
                T1.START_DATE ',SELECTED_FIELD_LIST,
                        ...
                        LEFT  JOIN  JOIN EPS_PROPOSAL_PERSONS T8 ON T8.PROPOSAL_ID = T1.PROPOSAL_ID AND T8.PROP_PERSON_ROLE_ID = 3 AND T8.PI_FLAG = ''Y''
