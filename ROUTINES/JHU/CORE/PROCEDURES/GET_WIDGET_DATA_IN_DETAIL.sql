...
ELSEIF AV_WIDGET = 'PROPOSAL_BY_SPONSOR_TYPE' THEN
	...
	LEFT OUTER JOIN EPS_PROPOSAL_PERSONS T3 ON T1.PROPOSAL_ID = T3.PROPOSAL_ID AND T3.PI_FLAG =''Y''
	...
	AND T2.SPONSOR_TYPE_CODE = ''',AV_SEARCH,'''');
...
IF month(NOW()) >= LS_FY_MONTH_CRITERIA THEN 
	...
	END IF;															  
SET LS_DYN_SQL = CONCAT('SELECT DISTINCT T1.AWARD_NUMBER, T1.ACCOUNT_NUMBER, T1.TITLE,  T2.DISPLAY_NAME AS SPONSOR_NAME , T1.AWARD_ID, T1.ANTICIPATED_TOTAL_AMOUNT, T1.PI_NAME FROM 
                         AWARD_MASTER_DATASET_RT T1 
                         LEFT JOIN SPONSOR T2  ON T1.SPONSOR_CODE = T2.SPONSOR_CODE
                         WHERE T1.AWARD_SEQUENCE_STATUS = ''ACTIVE'' 
                         AND T1.AWARD_STATUS_CODE = 1 
                       AND T1.BEGIN_DATE BETWEEN CONCAT(''', COL3, ''', ''', LS_FY_START_DATE, ''') 
                         AND CONCAT(''', COL3 + 1, ''', ''', LS_FY_END_DATE, ''') 
                         AND T1.SPONSOR_TYPE_CODE = ', AV_SEARCH, ' 
                         AND (', LS_UNIT_NUMBER_CONDITION, ' = ''NULL'' OR T1.LEAD_UNIT_NUMBER = ', LS_UNIT_NUMBER_CONDITION, LS_LEAD_UNIT_CONDITION, ') ', LS_FILTER_CONDITION );
...
ELSEIF AV_WIDGET = 'AWARD_BY_SPONSOR' THEN
	...
	IF LOCATE(',',AV_SEARCH) = 0 THEN
		SET LS_DYN_SQL = CONCAT('SELECT DISTINCT T1.AWARD_NUMBER,T1.ACCOUNT_NUMBER,TITLE,T2.DISPLAY_NAME AS SPONSOR_NAME, T1.AWARD_ID, T1.ANTICIPATED_TOTAL_AMOUNT FROM 
        award_master_dataset_rt T1
        LEFT JOIN SPONSOR T2  ON T1.SPONSOR_CODE = T2.SPONSOR_CODE
        WHERE T1.AWARD_SEQUENCE_STATUS = ''ACTIVE'' AND T1.AWARD_NUMBER LIKE ''%-00001%''
		AND T1.AWARD_STATUS_CODE = ''1''
...
ELSEIF AV_WIDGET = 'PENDING_PROPOSALS_OF_SPONSORS' THEN
    ...
    SET LS_DYN_SQL = CONCAT('SELECT DISTINCT T1.PROPOSAL_ID, T1.TITLE, T3.DISPLAY_NAME, T4.FULL_NAME, COALESCE(T2.TOTAL_COST,0.00) as TOTAL_COST,T1.PROPOSAL_NUMBER FROM  PROPOSAL T1
...
ELSEIF AV_WIDGET = 'PENDING_AWARDS_OF_SPONSORS' THEN
    ...
    SET LS_DYN_SQL = CONCAT('SELECT DISTINCT T1.AWARD_ID, T1.TITLE, T3.DISPLAY_NAME AS SPONSOR_NAME, T4.FULL_NAME, COALESCE(T2.TOTAL_COST,0.00) AS TOTAL_AMOUNT,T1.AWARD_NUMBER FROM AWARD T1 
...
ELSEIF AV_WIDGET = 'PENDING_INSTITUTE_PROPOSAL' THEN
 IF month(NOW()) >= LS_FY_MONTH_CRITERIA THEN 
	...
	WHERE (AV_UNIT_NUMBER IS NULL OR T1.HOME_UNIT_NUMBER = AV_UNIT_NUMBER
	OR CASE WHEN (AV_UNIT_NUMBER IS NOT NULL AND  AV_DESCENT_FLAG = 'Y') THEN T1.HOME_UNIT_NUMBER IN (SELECT CHILD_UNIT_NUMBER FROM UNIT_WITH_CHILDREN WHERE UNIT_NUMBER = AV_UNIT_NUMBER) ELSE '' END) 
	AND T1.PROPOSAL_SEQUENCE_STATUS = 'ACTIVE' AND T1.STATUS_CODE =1  AND T1.SUBMISSION_DATE BETWEEN LS_FY_START_DATE AND LS_FY_END_DATE;
...
ELSEIF AV_WIDGET = 'NOT_FUNDED_INSTITUTE_PROPOSAL' THEN
 IF month(NOW()) >= LS_FY_MONTH_CRITERIA THEN 
	...
	WHERE (AV_UNIT_NUMBER IS NULL OR T1.HOME_UNIT_NUMBER = AV_UNIT_NUMBER
	OR CASE WHEN (AV_UNIT_NUMBER IS NOT NULL AND  AV_DESCENT_FLAG = 'Y') THEN T1.HOME_UNIT_NUMBER IN (SELECT CHILD_UNIT_NUMBER FROM UNIT_WITH_CHILDREN WHERE UNIT_NUMBER = AV_UNIT_NUMBER) ELSE '' END) 
	AND T1.PROPOSAL_SEQUENCE_STATUS = 'ACTIVE' AND T1.STATUS_CODE =8  AND T1.SUBMISSION_DATE BETWEEN LS_FY_START_DATE AND LS_FY_END_DATE;
...
ELSEIF AV_WIDGET = 'FUNDED_INSTITUTE_PROPOSAL' THEN
	...
	WHERE (AV_UNIT_NUMBER IS NULL OR T1.HOME_UNIT_NUMBER = AV_UNIT_NUMBER
	OR CASE WHEN (AV_UNIT_NUMBER IS NOT NULL AND  AV_DESCENT_FLAG = 'Y') THEN T1.HOME_UNIT_NUMBER IN (SELECT CHILD_UNIT_NUMBER FROM UNIT_WITH_CHILDREN WHERE UNIT_NUMBER = AV_UNIT_NUMBER) ELSE '' END) 
	AND T1.PROPOSAL_SEQUENCE_STATUS = 'ACTIVE' AND T1.STATUS_CODE =2     AND T1.SUBMISSION_DATE BETWEEN LS_FY_START_DATE AND LS_FY_END_DATE;
...
ELSEIF AV_WIDGET = 'WITHDRAWN_INSTITUTE_PROPOSAL' THEN
 IF month(NOW()) >= LS_FY_MONTH_CRITERIA THEN 
	...
	WHERE  (AV_UNIT_NUMBER IS NULL OR T1.HOME_UNIT_NUMBER = AV_UNIT_NUMBER
	OR CASE WHEN (AV_UNIT_NUMBER IS NOT NULL AND  AV_DESCENT_FLAG = 'Y') THEN T1.HOME_UNIT_NUMBER IN (SELECT CHILD_UNIT_NUMBER FROM UNIT_WITH_CHILDREN WHERE UNIT_NUMBER = AV_UNIT_NUMBER) ELSE '' END) 
	AND T1.PROPOSAL_SEQUENCE_STATUS = 'ACTIVE' AND T1.STATUS_CODE =5  AND T1.SUBMISSION_DATE BETWEEN LS_FY_START_DATE AND LS_FY_END_DATE;
...
ELSEIF AV_WIDGET = 'PENDING_INSTITUTE_PROPOSAL_BY_SPONSOR_TYPE' THEN	
    ...
    WHERE T1.STATUS_CODE = 1 AND T1.PROPOSAL_SEQUENCE_STATUS = 'ACTIVE' AND T2.SPONSOR_TYPE_CODE = AV_SEARCH AND (AV_UNIT_NUMBER IS NULL OR T1.HOME_UNIT_NUMBER = AV_UNIT_NUMBER
	OR CASE WHEN (AV_UNIT_NUMBER IS NOT NULL AND  AV_DESCENT_FLAG = 'Y') THEN T1.HOME_UNIT_NUMBER IN (SELECT CHILD_UNIT_NUMBER FROM UNIT_WITH_CHILDREN WHERE UNIT_NUMBER = AV_UNIT_NUMBER) ELSE '' END) ;
